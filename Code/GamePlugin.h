...
// We then construct the local player entity and PlayerComponent instance when OnClientConnectionReceived is first called.
class CGamePlugin 
...
public:
	...
	void IterateOverPlayers(std::function<void(PlayerComponent& player)> func) const;
